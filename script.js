...
new TypeIt("#teks1", {
  ...
  strings: ["Sengg, Semoga tahun ini semua doa kamu dikabulkan, semua langkah kamu dimudahkan, dan semua kebahagiaan nyangkut di hidup kamu kayak api yang nggak mau lepas dari kamu.", "Semoga hal-hal yang membuat kamu runtuh turut menjadi alasan kamu untuk tetap tumbuh.", "Semoga setiap langkahmu dimudahkan hingga tercapai apa yang kamu inginkan."],
...
new TypeIt("#teks2", {
  ...
  strings: ["I Love You 4Ever, semoga allah dan segala ciptaannya selalu membahagiakan kamu bagimanapun caranya.", " ", "barakallah fi umrik, terima kasih udah bertahan sama api yaa seng.", " ", "- Wish you all the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
